...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'campaigns/create', name: 'brand-campaign-create', component: () => import('../views/brand/CampaignForm.vue') },
      { path: 'campaigns/:id', name: 'brand-campaign-detail', component: () => import('../views/brand/CampaignDetail.vue') },
      { path: 'campaigns/:id/edit', name: 'brand-campaign-edit', component: () => import('../views/brand/CampaignForm.vue') },
