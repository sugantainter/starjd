<template>
  <div class="min-h-screen bg-[#fafaf9] py-8 px-4 flex items-center justify-center lg:py-12">
    <div class="flex flex-col lg:flex-row items-start justify-center gap-8 lg:gap-16 w-full max-w-7xl">
      <!-- Left Column: Registration Content -->
      <div class="w-full max-w-lg">
        <h1 class="text-2xl font-bold text-[#1a1a1a] text-center lg:text-left">Create your account</h1>
        <p class="mt-2 text-center text-[#6b7280] lg:text-left">Join StarJD — choose how you want to use the platform.</p>
      ...
      <div class="w-full lg:max-w-2xl lg:sticky lg:top-24">
        <AppDownloadSection />
      </div>
    </div>
  </div>
