    ...
    <div>
            ...
            <table class="min-w-full divide-y divide-[#e2e8f0]">
                ...
                <tbody class="divide-y divide-[#e2e8f0]">
                    ...
                    >
                        ...
                        <td
                            class="max-w-xs truncate px-4 py-3 text-sm text-[#64748b]"
                        >
                            {{ item.quote }}
                        </td>
                        <td class="px-4 py-3 text-right">
                            <button
                                type="button"
                                class="text-[#e63946] hover:underline"
                                @click="openForm(item)"
                            >
                                Edit</button
                            ><button
        ...
        >
            <div class="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
                <h2 class="mb-4 text-lg font-semibold text-[#1a1a1a]">
...
const form = reactive({ name: "", role: "", quote: "", avatar: null });
...
async function save() {
    try {
        ...
        if (editing.value) {
            await axios.post(
                "/api/admin/testimonials/" + editing.value.id + "?_method=PUT",
                formData,
                {
