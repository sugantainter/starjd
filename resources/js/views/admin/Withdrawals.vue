            ...
            <tr v-for="r in filteredList" :key="r.id" class="hover:bg-slate-50/30 transition-colors group">
              ...
              <td class="px-8 py-6">
                ...
                <div v-else-if="r.receipt_url" class="flex gap-2">
                   <a :href="'/storage/' + r.receipt_url" target="_blank" class="h-9 w-9 rounded-xl bg-slate-100 flex items-center justify-center text-slate-600 hover:text-indigo-600 border border-slate-200 transition" title="View Receipt">
