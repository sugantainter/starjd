    ...
    <nav class="nav-bar nav-bar-bg flex items-center w-full h-auto rounded-[10rem] border-b-0 justify-between px-3 py-2 sm:px-8 sm:py-2">
      ...
      <div class="flex items-center gap-6 md:gap-8 ml-auto">
        ...
        <div class="hidden items-center gap-4 md:flex">
          ...
          <router-link to="/creators" class="text-sm font-semibold transition hover:text-[#fc4402]">Campaign</router-link>
            ...
            >
              ...
              >
                <div class="flex min-h-[280px]">
                  ...
                  <div class="flex flex-1 flex-col border-r border-[#e5e7eb] py-4">
                    <span class="mb-2 inline-block px-4 text-xs font-semibold uppercase tracking-wide text-[#fc4402]">All Services</span>
                    <div class="flex flex-col gap-0.5 px-4">
                      <router-link
                  ...
                  <router-link
                    ...
                    @click="servicesDropdownOpen = false"
                  >
                    <span class="mb-2 inline-block text-xs font-semibold uppercase tracking-wide text-[#fc4402]">Case study</span>
                    ...
                    <div class="mt-3 aspect-[16/10] overflow-hidden rounded-lg bg-[#e5e7eb]">
                      ...
                      />
                      <div v-else class="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#fc4402]/15 to-[#1a1a1a]/10">
                        <span class="text-3xl font-bold text-[#fc4402]/40">StarJD</span>
                      </div>
                    </div>
                  </router-link>
                </div>
          ...
          >
            ...
            >
              Our Work
              <svg class="h-4 w-4 shrink-0 transition-transform" :class="{ 'rotate-180': ourWorkDropdownOpen }" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
              </svg>
            </button>
            <Transition
            ...
            >
              ...
              >
                <router-link to="/blog" class="block px-4 py-2.5 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="ourWorkDropdownOpen = false">Blog</router-link>
                <router-link to="/guide" class="block px-4 py-2.5 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="ourWorkDropdownOpen = false">Guide</router-link>
                <router-link to="/videos" class="block px-4 py-2.5 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="ourWorkDropdownOpen = false">Projects</router-link>
              </div>
            </Transition>
          </div>
          <router-link to="/about" class="text-sm font-semibold transition hover:text-[#fc4402]">About</router-link>
              ...
              >
                ...
                >
                  ...
                  <template v-else-if="user.role === 'brand'">
                    <router-link to="/brand/dashboard" class="block px-4 py-2.5 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="userMenuOpen = false">Brand Dashboard</router-link>
                    <router-link to="/brand/creators" class="block px-4 py-2.5 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="userMenuOpen = false">Discover Creators</router-link>
                  </template>
          ...
          <template v-else>
            <router-link to="/login" class="rounded-lg bg-[#fc4402] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#e63d02]">Login</router-link>
          </template>
        </div>
      </div>
    </nav>
      ...
      >
        <div class="mx-auto max-w-6xl px-4 py-4">
          <div class="flex flex-col gap-1">
            <router-link to="/" class="rounded-lg px-4 py-3 text-sm font-medium text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">Home</router-link>
            <router-link to="/about" class="rounded-lg px-4 py-3 text-sm font-medium text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">About</router-link>
            <router-link to="/contact" class="rounded-lg px-4 py-3 text-sm font-medium text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">Contact</router-link>
            <div class="py-1">
              <p class="px-4 py-2 text-xs font-semibold uppercase tracking-wide text-[#64748b]">Our Work</p>
              <router-link to="/blog" class="block rounded-lg px-4 py-2.5 pl-6 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">Blog</router-link>
              <router-link to="/guide" class="block rounded-lg px-4 py-2.5 pl-6 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">Guide</router-link>
              <router-link to="/products" class="block rounded-lg px-4 py-2.5 pl-6 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">Products</router-link>
            </div>
            <router-link to="/services" class="rounded-lg px-4 py-3 text-sm font-medium text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">Services</router-link>
            <router-link to="/videos" class="rounded-lg px-4 py-3 text-sm font-medium text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">Videos</router-link>
            <div class="py-1">
              <p class="px-4 py-2 text-xs font-semibold uppercase tracking-wide text-[#64748b]">Creators</p>
              <router-link v-for="(item, idx) in creatorCategories" :key="'mob-cat-' + idx" :to="item.slug ? { path: '/creators', query: { category: item.slug } } : '/creators'" class="block rounded-lg px-4 py-2.5 pl-6 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">{{ item.name }}</router-link>
            </div>
            <template v-if="user">
              ...
              <template v-else-if="user.role === 'brand'">
                <router-link to="/brand/dashboard" class="rounded-lg px-4 py-3 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">Brand Dashboard</router-link>
                <router-link to="/brand/creators" class="rounded-lg px-4 py-3 text-sm text-[#1a1a1a] transition hover:bg-[#fc4402]/5 hover:text-[#fc4402]" @click="navMobileOpen = false">Discover Creators</router-link>
              </template>
              <template v-else-if="user.role === 'admin'">
            ...
            <template v-else>
              <div class="mt-2 flex flex-col gap-2 border-t border-[#e5e7eb] pt-3">
                <router-link to="/login" class="rounded-lg border border-[#e5e7eb] px-4 py-3 text-center text-sm font-medium transition hover:border-[#fc4402] hover:text-[#fc4402]" @click="navMobileOpen = false">Login</router-link>
                ...
                <router-link to="/brand-landing" class="rounded-lg bg-[#fc4402] px-4 py-3 text-center text-sm font-medium text-white transition hover:bg-[#e63d02]" @click="navMobileOpen = false">Join as Brand</router-link>
              </div>
            </template>
          </div>
        </div>
...
const creatorsDropdownImage = ref('https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=400&h=500&fit=crop');
const creatorCategories = [
  ...
  { name: 'Fashion/Lifestyle Influencers', slug: 'fashion-lifestyle-influencers' },
];
const services = ref([]);
...
function onClickOutside(e) {
  ...
  if (ourWorkRef.value && !ourWorkRef.value.contains(e.target)) ourWorkDropdownOpen.value = false;
  if (creatorsRef.value && !creatorsRef.value.contains(e.target)) creatorsDropdownOpen.value = false;
